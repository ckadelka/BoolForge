...
# Tutorial #4 markdown (including appended ending sections).
MD = """
...
## What you will learn
*What you will learn:* This tutorial will teach you how to generate random n-input Boolean functions under flexible constraints, including:
...
out_path = "BoolForge_Tutorial_4_random_Boolean_function_generation.ipynb"
