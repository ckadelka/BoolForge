...
*BoolForge* has a handful of methods that make use of the [CANA](https://github.com/CASCI-lab/CANA) package. However, as these methods are not integral to the functionality of this package, *CANA* is not considered a dependency of *BoolForge* and must be downloaded independently. [You can learn more about CANA here](https://casci-lab.github.io/CANA/index.html).

*BoolForge* makes use of [Numba](https://numba.pydata.org/) to speed of computation time. It is highly recomended you install *Numba*. Note that *Numba* is not required to maintain functionality.
